    ...
    <form id="jegyzekForm">
        ...
        <div class="row g-2 align-items-center mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="time" class="form-control form-control-sm" id="ido" name="ido" placeholder="Idő (pl. 13:00)" required>
            </div>
            <div class="col-md-3">
                <label for="ugyszam" class="form-label">Ügyszám</label>
                <input type="text" class="form-control form-control-sm" id="ugyszam" name="ugyszam" placeholder="Ügyszám (pl. P.2023/2023)" required>
            </div>
            <div class="row g-2 mb-4">
            <div class="col-md-6">
